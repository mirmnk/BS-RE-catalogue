...
class tx_vvreticker_model_vOffers extends tx_vvreticker_model_vOffersNProjects {

        function tx_vvreticker_model_vOffers($controller = null, $parameter = null) {
        ...
        function getTableSelectFields($table) {
        	$fields = 'uid, gid, tstamp, images, tx_vvreticker_votext';
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/vv_reticker/models/class.tx_vvreticker_model_vOffers.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/vv_reticker/models/class.tx_vvreticker_model_vOffers.php']);
}
